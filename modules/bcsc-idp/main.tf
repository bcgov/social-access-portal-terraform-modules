module "bcsc_idp" {
  ...
  alias             = var.idp_alias
  authorization_url = "${var.keycloak_url}/login/oidc/authorize"
  token_url         = "${var.keycloak_url}/oauth2/token"
  user_info_url     = "${var.keycloak_url}/oauth2/userinfo"
  jwks_url          = "${var.keycloak_url}/oauth2/jwk"
